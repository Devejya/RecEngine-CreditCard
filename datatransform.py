...
def transform(df, emerald, aero, prod):
    ...
    #df_final = df_final[(df_final['match_cpc_before_TAW']!=1)]
    #df_final = df_final.drop('match_cpc_before_TAW',axis=1)
...
if __name__ == "__main__":
    ...
    spark_df = spark.read.table("anp_camktedw1_sandbox.jai_prem_ORD_CSV")
