...
def objective(space):
    '''
    Obejctive Function for HyperParameter Optimization for Logistic Regression multi_class Classification Problem. Returns the best score found
    '''
    global best_score
...
#         sys.exit(5)
    ...
    logreg_space={
                ...
                'multi_class' : hp.choice('x_multi_class',['ovr','multinomial']),
